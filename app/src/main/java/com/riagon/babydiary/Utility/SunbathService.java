...
public class SunbathService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        runningStatus = prefs.getString("SunbathRunning", "");

        if (!runningStatus.equals("Pause")) {

        //    mNotificationManager.cancel(notifyID);
            editor.putLong("sunbathEndTime", sunbathEndTime);
            editor.apply();
...
//        timeStart = dateFormatUtility.getTimeFormat(formHelper.getTimeNow());
        sunbathEndTime = System.currentTimeMillis() + totalLeftSeconds * 1000;
        ...
        timer = new CountDownTimer(totalLeftSeconds * 1000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                intent1local.setAction("Sunbath Counter");
...
//                timeEnd = dateFormatUtility.getDateFormatWithHours(endDate);
                ...
                intent1local.putExtra("SunbathDuration", durationString);
                intent1local.putExtra("SunbathSecondLeft", totalLeftSeconds);
...
//                intent1local.putExtra("timeEnd", timeEnd.getTime());
    ...
    public void refreshNotifications(String message) {
        ...
        builder.setContentTitle(message)
                ...
                .setSmallIcon(R.drawable.ic_cvsunbathewhite).build();
