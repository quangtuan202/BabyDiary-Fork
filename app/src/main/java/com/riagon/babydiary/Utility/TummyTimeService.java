...
public class TummyTimeService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        runningStatus = prefs.getString("TummyRunning", "");

        if (!runningStatus.equals("Pause")) {

            editor.putLong("tummyEndTime", tummyEndTime);
            editor.apply();
    ...
    public void startCount() {
        ...
        tummyEndTime = System.currentTimeMillis() + totalLeftSeconds * 1000;
        ...
        timer = new CountDownTimer(totalLeftSeconds * 1000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                intent1local.setAction("Tummy Counter");
                ...
                intent1local.putExtra("TummyDuration", durationString);
                intent1local.putExtra("TummySecondLeft", totalLeftSeconds);
    ...
    public void refreshNotifications(String message) {
        ...
        builder.setContentTitle(message)
                ...
                .setSmallIcon(R.drawable.ic_tummytimewhite).build();
